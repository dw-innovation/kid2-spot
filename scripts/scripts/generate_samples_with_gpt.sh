...
--query_file scripts/datageneration/results/IMR_Dataset_v12/samples.jsonl \
--output_file scripts/datageneration/results/IMR_Dataset_v12/gpt_generations.jsonl