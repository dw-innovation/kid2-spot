...
class TestPropertyGenerator(unittest.TestCase):
    ...
    def test_proper_noun_property(self):
        tag_attribute = TagAttribute(**{"descriptors": ["name"], "tags": [
            Tag(**{"key": "cuisine", "operator": "~", "value": "***any***"})]})
    ...
    def test_numerical_property(self):
        ...
        numerical_tag_attribute = TagAttribute(**{"descriptors": ["lanes in each direction", "lanes going in each direction"], "tags": [
